...
echo "5 4 * * * `pwd`/do_symlinks.sh" >> /var/spool/cron/crontabs/root
echo "0 2 * * 7 `pwd`/do_backups.sh weekly" >> /var/spool/cron/crontabs/root
echo "5 2 * * 7 `pwd`/do_symlinks.sh" >> /var/spool/cron/crontabs/root
echo "0 4 1 * * `pwd`/do_backups.sh monthly" >> /var/spool/cron/crontabs/root
echo "5 4 1 * * `pwd`/do_symlinks.sh" >> /var/spool/cron/crontabs/root
